/* ==================================================
   CATÁLOGO DE Cafes Molidos - ALLASIAN
================================================== */
...
const productosCafesMolidos = [

    {
        ...
        busqueda:
            "cafes molidos cafe molido polvo preparar",
...
function buscarProductos() {
    ...
    if (textoBuscado === "") {
        ...
        contadorResultados.textContent =
            `Mostrando todos los cafes molidos (${productosCafesMolidos.length})`;
        ...
        contadorResultados.textContent =
            `Se encontró 1 cafe molido para "${textoOriginal}"`;
        ...
        contadorResultados.textContent =
            `Se encontraron ${productosFiltrados.length} cafes molidos para "${textoOriginal}"`;
