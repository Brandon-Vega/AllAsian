...
const productosPodsCafe = [

    {
        ...
        busqueda:
            "pods de café pod de café cafetera keurig nespresso",
...
function buscarProductos() {
    ...
    const productosFiltrados =
        productosPodsCafe.filter((producto) => {
    ...
    if (textoBuscado === "") {
        ...
        contadorResultados.textContent =
            `Mostrando todos los pods de café (${productosPodsCafe.length})`;
        ...
        contadorResultados.textContent =
            `Se encontró 1 caja de pods de café para "${textoOriginal}"`;
        ...
        contadorResultados.textContent =
            `Se encontraron ${productosFiltrados.length} cajas de pods de café para "${textoOriginal}"`;
...
botonLimpiarBusqueda.addEventListener(
    ...
    () => {
        ...
        mostrarProductos(productosPodsCafe);
