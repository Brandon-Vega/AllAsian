/* ==================================================
   CATÁLOGO DE ALIMENTOS - ALLASIAN
================================================== */
...
const productosAlimentos = [

    {
        ...
        imagen: "alimentos/alimento1.png",

        busqueda:
            "alimento alimentos comida food snack snacks preparado importado",
...

    {
        ...
        imagen: "alimentos/alimento2.png",
...

    {
        ...
        imagen: "alimentos/alimento3.png",
...

    {
        ...
        imagen: "alimentos/alimento4.png",
...

    {
        ...
        imagen: "alimentos/alimento5.png",
...

    {
        ...
        imagen: "alimentos/alimento6.png",
...

    {
        ...
        imagen: "alimentos/alimento7.png",
...

    {
        ...
        imagen: "alimentos/alimento8.png",
...
function buscarProductos() {
    ...
    const productosFiltrados =
        productosAlimentos.filter((producto) => {
    ...
    if (textoBuscado === "") {
        ...
        contadorResultados.textContent =
            `Mostrando todos los alimentos (${productosAlimentos.length})`;
        ...
        contadorResultados.textContent =
            `Se encontró 1 alimento para "${textoOriginal}"`;
        ...
        contadorResultados.textContent =
            `Se encontraron ${productosFiltrados.length} alimentos para "${textoOriginal}"`;
...
botonLimpiarBusqueda.addEventListener(
    ...
    () => {
        ...
        mostrarProductos(productosAlimentos);
