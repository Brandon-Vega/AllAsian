...
const productosSabritas = [

    {
        nombre: "Sabrita xyz",
        precio: "$300.00 MXN",

        imagen: "sabritas/sabrita1.png",

        busqueda:
            "sabrita sabritas papas chips botana botanas snack snacks picante chile queso",
...
function buscarProductos() {
    ...
    const productosFiltrados =
        productosSabritas.filter((producto) => {
    ...
    if (textoBuscado === "") {
        ...
        contadorResultados.textContent =
            `Mostrando todas las sabritas (${productosSabritas.length})`;
        ...
        contadorResultados.textContent =
            `Se encontró 1 sabrita para "${textoOriginal}"`;
        ...
        contadorResultados.textContent =
            `Se encontraron ${productosFiltrados.length} sabritas para "${textoOriginal}"`;
...
botonLimpiarBusqueda.addEventListener(
    ...
    () => {
        ...
        mostrarProductos(productosSabritas);
