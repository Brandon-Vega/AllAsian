/* ==================================================
   CATÁLOGO DE CREAMERS DE CAFÉ - ALLASIAN
================================================== */
...
const productosCreamersCafe = [

    {
        nombre: "Creamer xyz",
        precio: "$300.00 MXN",

        imagen: "creamerscafe/creamer1.png",

        busqueda:
            "creamer creamers cafe café coffee crema vainilla vanilla caramelo caramel",
...

    {
        ...
        imagen: "creamerscafe/creamer2.png",
...

    {
        ...
        imagen: "creamerscafe/creamer3.png",
...

    {
        ...
        imagen: "creamerscafe/creamer4.png",
...

    {
        ...
        imagen: "creamerscafe/creamer5.png",
...

    {
        ...
        imagen: "creamerscafe/creamer6.png",
...

    {
        ...
        imagen: "creamerscafe/creamer7.png",
...

    {
        ...
        imagen: "creamerscafe/creamer8.png",
...
function buscarProductos() {
    ...
    const productosFiltrados =
        productosCreamersCafe.filter((producto) => {
    ...
    if (textoBuscado === "") {
        ...
        contadorResultados.textContent =
            `Mostrando todos los creamers (${productosCreamersCafe.length})`;
        ...
        contadorResultados.textContent =
            `Se encontró 1 creamer para "${textoOriginal}"`;
        ...
        contadorResultados.textContent =
            `Se encontraron ${productosFiltrados.length} creamers para "${textoOriginal}"`;
...
botonLimpiarBusqueda.addEventListener(
    ...
    () => {
        ...
        mostrarProductos(productosCreamersCafe);
