...
const productosBebidas = [

    {
        ...
        imagen: "bebidas/bebida1.png",

        busqueda:
            "bebida bebidas drink drinks marca sabor importada",
...
function buscarProductos() {
    ...
    const productosFiltrados =
        productosBebidas.filter((producto) => {
    ...
    if (textoBuscado === "") {
        ...
        contadorResultados.textContent =
            `Mostrando todas las bebidas (${productosBebidas.length})`;
        ...
        contadorResultados.textContent =
            `Se encontró 1 bebida para "${textoOriginal}"`;
        ...
        contadorResultados.textContent =
            `Se encontraron ${productosFiltrados.length} bebidas para "${textoOriginal}"`;
...
botonLimpiarBusqueda.addEventListener(
    ...
    () => {
        ...
        mostrarProductos(productosBebidas);
