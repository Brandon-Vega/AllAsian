...
const productosSalsas = [

    {
        nombre: "Salsa xyz",
        precio: "$300.00 MXN",

        imagen: "salsas/salsa1.png",

        busqueda:
            "salsa salsas sauce picante spicy chile chili",
...
function buscarProductos() {
    ...
    const productosFiltrados =
        productosSalsas.filter((producto) => {
    ...
    if (textoBuscado === "") {
        ...
        contadorResultados.textContent =
            `Mostrando todas las salsas (${productosSalsas.length})`;
        ...
        contadorResultados.textContent =
            `Se encontró 1 salsa para "${textoOriginal}"`;
        ...
        contadorResultados.textContent =
            `Se encontraron ${productosFiltrados.length} salsas para "${textoOriginal}"`;
